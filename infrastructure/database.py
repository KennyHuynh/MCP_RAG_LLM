    ...
    def search_templates(self, query: str):
        ...
        for doc in results:
            if "source" not in doc.metadata:
                # Fallback to prevent the LLM from receiving a malformed source reference
                doc.metadata["source"] = "playwright_docs"
        return results
